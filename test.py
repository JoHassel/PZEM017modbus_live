...
if __name__ == "__main__":
    ...
    while True:
        try:
            ...
            test_list_2 = [2,3,4,5,6]
            test_list_3 = [3,4,5,6,7]
            test_list_4 = [4,5,6,7,8]
            test_list_5 = [5,6,7,8,9]
            time.sleep(1)  # wait for 1 second
        except KeyboardInterrupt:
            save_results(test_list_1, test_list_2, test_list_3, test_list_4, test_list_5)
